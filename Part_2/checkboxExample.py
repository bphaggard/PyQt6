...
from PyQt6.QtWidgets import QApplication, QWidget, QLabel, QHBoxLayout, QCheckBox, QVBoxLayout
import sys
...
class Window(QWidget):
    def __init__(self):
        ...
        self.check2 = QCheckBox("Kotlin")
        self.check2.setIcon(QIcon("images/kotlin.png"))
        ...
        self.check3 = QCheckBox("Swift")
        self.check3.setIcon(QIcon("images/swift.png"))
